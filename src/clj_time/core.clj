...
(s/fdef
  ...
  (s/cat
    :i-a
    (partial instance? org.joda.time.Interval)
    :i-b
    (partial instance? org.joda.time.Interval))
  :ret
  boolean?)
(s/fdef
  ...
  (s/cat
    ...
    (s/or
      :org.joda.time.Years
      (partial instance? org.joda.time.Years)
      :org.joda.time.Days
...
(s/fdef
  ...
  (s/cat)
  :ret
  (partial instance? java.util.Collections$UnmodifiableSortedSet))
(s/fdef
  date-midnight
  :args
  (s/alt
    ...
    (s/cat :year int?)
    :3-args
    (s/cat :year int? :month int? :day int?))
  :ret
  (partial instance? org.joda.time.DateMidnight))
(s/fdef
  date-time
  :args
  (s/alt
    ...
    (s/cat :year int?)
    :2-args
    (s/cat :year int? :month int?)
    :3-args
    (s/cat :year int? :month int? :day int?)
    :4-args
    (s/cat :year int? :month int? :day int? :hour int?)
    :5-args
    (s/cat :year int? :month int? :day int? :hour int? :minute int?)
    :6-args
    (s/cat
      :year
      int?
...
(s/fdef
  days?
  :args
  (s/cat :val (partial instance? org.joda.time.Days))
  :ret
  boolean?)
(s/fdef
  default-time-zone
  ...
  (s/cat)
  :ret
  (partial instance? org.joda.time.tz.CachedDateTimeZone))
(s/fdef
  do-at*
  :args
  (s/cat
  ...
  (s/or
    ...
    (partial instance? org.joda.time.LocalDate)))
(s/fdef
  earliest
  :args
  (s/alt
    ...
    (s/cat
      :dts
      (s/coll-of
        (s/nilable (partial instance? org.joda.time.DateTime))
        :into
        vector?))
    :2-args
    (s/cat
...
(s/fdef
  ...
  :args
  (s/cat :in (partial instance? org.joda.time.Interval))
  :ret
  (partial instance? org.joda.time.DateTime))
(s/fdef
  epoch
...
(s/fdef
  floor
  :args
  (s/cat :dt (partial instance? org.joda.time.DateTime) :dt-fn ifn?)
  :ret
  any?)
(s/fdef
  from-now
  :args
  (s/cat :period (partial instance? org.joda.time.Minutes))
  :ret
  (partial instance? org.joda.time.DateTime))
(s/fdef
  from-time-zone
  ...
  (s/cat
    ...
    (s/or
      ...
      (partial instance? org.joda.time.tz.FixedDateTimeZone)))
  :ret
  (partial instance? org.joda.time.DateTime))
(s/fdef
  hours
  ...
  (s/or
    :org.joda.time.Hours
    (partial instance? org.joda.time.Hours)
    :org.joda.time.PeriodType
    (partial instance? org.joda.time.PeriodType)))
(s/fdef
  hours?
  :args
  (s/cat :val (partial instance? org.joda.time.Hours))
  :ret
  boolean?)
(s/fdef
  interval
...
(s/fdef
  ...
  (s/alt
    ...
    (s/cat
      ...
      int?))
  :ret
  (partial instance? org.joda.time.LocalDateTime))
(s/fdef
  local-time
  :args
  (s/alt
    ...
    (s/cat :hour int?)
    :3-args
    (s/cat :hour int? :minute int? :second int?)
    :4-args
    (s/cat :hour int? :minute int? :second int? :millis int?))
  :ret
  (partial instance? org.joda.time.LocalTime))
(s/fdef
  max-date
  :args
  (s/alt
    :1-arg
    (s/cat :dt (partial instance? org.joda.time.DateTime))
    :7-args
    (s/cat
      :dt
      (partial instance? org.joda.time.DateTime)
...
(s/fdef
  ...
  (s/cat :n int?)
  :ret
  (partial instance? org.joda.time.Period))
(s/fdef
  min-date
  :args
  (s/alt
...
(s/fdef
  mins-ago
  :args
  (s/cat :d (partial instance? org.joda.time.DateTime))
  :ret
  int?)
(s/fdef
  minus
  ...
  (s/alt
    ...
    (s/cat
      ...
      (s/or
        ...
        (partial instance? org.joda.time.Minutes)
        :org.joda.time.Years
        (partial instance? org.joda.time.Years)
        :org.joda.time.Days
        (partial instance? org.joda.time.Days)))
...
(s/fdef
  minutes?
  :args
  (s/cat :val (partial instance? org.joda.time.Minutes))
  :ret
  boolean?)
(s/fdef
  months
  ...
  (s/or
    ...
    (partial instance? org.joda.time.Months)
    :org.joda.time.PeriodType
    (partial instance? org.joda.time.PeriodType)))
(s/fdef
  months?
  :args
  (s/cat :val (partial instance? org.joda.time.Months))
  :ret
  boolean?)
(s/fdef
  now
...
(s/fdef
  ...
  :args
  (s/cat :dt (partial instance? org.joda.time.DateTime) :n int?)
  :ret
  (partial instance? org.joda.time.DateTime))
(s/fdef
...
(s/fdef
  ...
  (s/cat
    ...
    (partial instance? org.joda.time.Interval)
    :i-b
    (s/nilable (partial instance? org.joda.time.Interval)))
  :ret
  (s/nilable (partial instance? org.joda.time.Interval)))
(s/fdef
  overlaps?
  ...
  (s/alt
    ...
    (s/cat
      ...
      (s/or
        ...
        (partial instance? org.joda.time.Hours)
        :org.joda.time.Weeks
        (partial instance? org.joda.time.Weeks)
        :org.joda.time.Minutes
        (partial instance? org.joda.time.Minutes)
        :org.joda.time.Years
        (partial instance? org.joda.time.Years)
    ...
    (s/cat
      ...
      (partial instance? org.joda.time.Minutes)
      :ps-4
      (partial instance? org.joda.time.Seconds)
      :ps-5
      (partial instance? org.joda.time.Period)))
  :ret
  (s/or
...
(s/fdef
  seconds?
  :args
  (s/cat :val (partial instance? org.joda.time.Seconds))
  :ret
  boolean?)
(s/fdef
  start
...
(s/fdef
  ...
  (s/or
    ...
    (partial instance? org.joda.time.UTCDateTimeZone)))
(s/fdef
...
(s/fdef
  ...
  (s/alt
    ...
    (s/cat :hours int? :minutes int?)
    :3-args
    (s/cat :hours int? :minutes int? :seconds int?)
    :4-args
    (s/cat :hours int? :minutes int? :seconds int? :millis int?))
  :ret
  (partial instance? org.joda.time.DateTime))
(s/fdef
  today-at-midnight
  ...
  (s/alt
    ...
    (s/cat)
    :1-arg
    (s/cat :tz (partial instance? org.joda.time.tz.FixedDateTimeZone)))
  :ret
  (partial instance? org.joda.time.DateMidnight))
(s/fdef
  weeks
...
(s/fdef
  weeks?
  :args
  (s/cat :val (partial instance? org.joda.time.Weeks))
  :ret
  boolean?)
(s/fdef
...
(s/fdef
  ...
  (s/alt
    ...
    (s/cat :year int? :month int?))
  :ret
  (partial instance? org.joda.time.YearMonth))
(s/fdef
  years
  :args
  (s/alt :0-args (s/cat) :1-arg (s/cat :n int?))
...
(s/fdef
  years?
  :args
  (s/cat :val (partial instance? org.joda.time.Years))
  :ret
  boolean?)
(s/fdef
  yesterday
